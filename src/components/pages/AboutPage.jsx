...
export default function AboutPage () {
    return (
        <><div className="flex justify-items-start">
            <h2 className="text-5xl p-8 text-teal-600 font-medium font-burtons">About</h2>
        </div><div className="p-10 flex items-center flex-col justify-center">
                ...
                <div className="text-center flex-col p-3 md:py-5 md:px-15 shadow-2xl rounded-xl my-10 max-w-2xl bg-slate-300">
